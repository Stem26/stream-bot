...
```aiignore vpn
проверить и перезапустить доке для vpn 
docker ps
docker restart amnezia-wireguard amnezia-awg
```
...
cd /root/stream-bot node scripts/delete-telegram-messages.js 1 -1001974544555 8549936481:AAF7h4s6k80syWbzgVsk1dwn3YV0J4Hb7OE
...
добавить хорни +
добавить фурри +
добавить веб интерфес куда можно будет добавлять новые команды и ссылки к ним менять если поменялась ссылка итд // что то уже есть
реализовать возможность рандомной установки в чат +
добавить шатаут от рейдов +
перенести предстказания в веб интерфес +
Добавить в тг бота одну команду на всё +
добавить для випов исключения на отправку ссылок в чат ?
Добавить управление рейдом, включать/выключать, от какого количества зрителей +

баг баг нашёл небольшой. У бота внутри мут выдаётся сразу, а на канале после драки отчёт в боте начинается раньше чем на твиче
добавить включение плашки 18+ через команду
