...
# идеи: дуэль может уебать двоих | спасти из маймача, снять таймач со всех, стопдуэли не влияют на стримера и тех кто пойдёт к нему в очередь, вызывать на дуэли индивидуально для стримера.
```
```bash
              идеи: 
дуэль может уебать двоих +
спасти из маймача, снять таймач со всех, 
стопдуэли не влияют на стримера и тех кто пойдёт к нему в очередь, 
вызывать на дуэли индивидуально для стримера.
