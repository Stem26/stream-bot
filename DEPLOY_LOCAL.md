...
Кнопку  все ссылки пенерести в верхний угол
сохранить настройки где то сохранить поправить 
поправить расположение тоглов для вклчюения дуэлей 
поправить инпут времени
убрать чёрточку в тёмной теме после номера 
переименовать ротацию ссылок в ротацию команд
```